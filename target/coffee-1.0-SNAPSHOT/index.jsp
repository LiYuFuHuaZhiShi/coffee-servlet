	...
	<div
		...
		<div class="container">
			...
			<div class="col-xs-3 ">
				<br /> <br />
				<ul>
					<li class="li_style_none"><button type="submit" class="btn btn-info navbar-btn"
							data-toggle="modal" data-target="#login" href="">
							<span class="glyphicon glyphicon-log-in"></span>&nbsp;登&nbsp;&nbsp;录
						</button></li>
					<!-- 形成简单间隔 -->
					<li class="li_style_none">&nbsp;&nbsp;&nbsp;</li>
					<li class="li_style_none"><button type="submit" class="btn btn-success navbar-btn"
